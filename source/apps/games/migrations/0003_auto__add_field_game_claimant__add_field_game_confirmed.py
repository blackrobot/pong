...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.claimant'
        db.add_column(u'games_game', 'claimant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='claims', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Game.confirmed'
        db.add_column(u'games_game', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.claimant'
        db.delete_column(u'games_game', 'claimant_id')

        # Deleting field 'Game.confirmed'
        db.delete_column(u'games_game', 'confirmed')
