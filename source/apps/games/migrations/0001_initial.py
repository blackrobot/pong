...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rating'
        db.create_table(u'games_rating', (
        ...
        db.send_create_signal(u'games', ['Rating'])
        ...
        db.create_table(u'games_game', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wins', to=orm['auth.User'])),
            ('loser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='losses', to=orm['auth.User'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'games_rating')
